...
export const DINOS: Dino[] = [
  ...
  {
    id: 'brachio', name: 'Brachiosaurus', nameNl: 'Brachiosaurus',
    body: { x: 0.55, y: 0.60, rx: 0.155, ry: 0.115, rot: -0.12 },
    neck: { to: [0.23, 0.15], thick: 0.055, curve: -0.10 },
    head: { kind: 'small', len: 0.085, depth: 0.05, tilt: -0.5 },
    tail: { to: [0.97, 0.66], thick: 0.075, sag: 0.04 },
    legs: [
      { hip: [0.65, 0.68], foot: [0.665, 0.90], thick: 0.05 },
      { hip: [0.45, 0.66], foot: [0.44, 0.90], thick: 0.055 },
    ],
    skin: '#7f85a0', belly: '#c7cbd8',
    fact: 'It reached the treetops without ever leaving the ground.',
    factNl: 'Hij kwam bij de boomtoppen zonder ooit te hoeven klimmen.',
  },
  {
