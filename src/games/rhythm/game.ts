/**
 * Klankhuis - the sound house, in Bramblewood.
 *
...
export class Rhythm {
  ...
  private drawChrome(): void {
    ...
    // in the corner, which sit over the canvas on every page in Bramblewood
   ...
   *
   * They are the same size on every page of Bramblewood and they sit over the canvas, so the
