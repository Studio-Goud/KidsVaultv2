...
Twenty-one entries: seventeen games and four discovery journeys. One guide, a meerkat called Suri, who
...
npm run audit           # 27 screens x 5 screen shapes in a real browser, 0 faults
```
