...
Twenty entries: seventeen games and three discovery journeys. One guide, a meerkat called Suri, who
...
npm test                # 1433 checks, no browser, tests/run.mjs
npm run audit           # 26 screens x 5 screen shapes in a real browser, 0 faults
```
